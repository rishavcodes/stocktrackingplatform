  ...
  return (
    <div className="dark:bg-blackShade min-h-screen pt-10">
      <div className="bg-white dark:bg-black p-10 w-[90%] mx-auto">
        <h1 className="font-bold text-2xl">Copyright</h1>
        <div>
          <br />
          [Tradeboxlive.com]
          <br />
          Tradebox Fintech Solution Pvt Ltd,
          <br />
          1471, Valencia Tower, Mahagun Moderne, sector 78, Noida-201301
          <br />
          Website: www.tradeboxlive.com | Email: info@tradeboxlive.com
          <br />
          Copyright © 2020 Tradebox Fintech Solution Pvt Ltd. All rights
          reserved.
          <DocumentPoint
