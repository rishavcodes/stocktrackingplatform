...
//  Animated counter component for percentage text
function AnimatedPercentage({ percentage }: { percentage: number }) {
  ...
  return (
    <motion.span className="text-white font-bold text-sm ml-3 w-12 text-right trading-text-dark">
      {rounded}
    </motion.span>
  );
}
                    ...
                    <div className="flex items-center space-x-3 flex-1">
                      ...
                      <div className="flex-1 bg-gray-700 rounded-full h-4 relative overflow-hidden">
                        <motion.div
                          ...
                          transition={{ delay: 1 + index * 0.1, duration: 10 }}
                        />
