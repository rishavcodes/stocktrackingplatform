  ...
  const steps = [
    {
      ...
      description: "Explore recommendations, portfolios, and advisory services",
      icon: Search,
      color: "#3B82F6",
    },
    {
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        <motion.div
          ...
          whileTap={{ scale: 0.98 }}
        >
          <Button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-md hover:shadow-lg transition-all duration-300">
  ...
  const testimonials = [
    {
      ...
      content: "The quality of research and timely recommendations have helped us achieve consistent returns.",
      rating: 5,
    },
    {
      name: "Priya Sharma",
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Your trusted platform for premium financial services and investment opportunities.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Recommendations", "Research Analysts", "Portfolios", "Services", "Research Reports", "Events"].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Blog", "Research", "Market Analysis", "FAQ", "Support", "API"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-gray-400 hover:text-white transition-colors">
                    {item}
                  </Link>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-400">
            <span>SEBI Registration: INZ000123456</span>
